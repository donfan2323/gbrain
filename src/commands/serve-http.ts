...
export async function runServeHttp(engine: BrainEngine, options: ServeHttpOptions) {
  ...
  app.post('/admin/login', adminAuthRateLimiter, express.json(), async (req, res) => {
    const startTime = Date.now();
  ...
  app.post('/admin/api/issue-magic-link', adminAuthRateLimiter, express.json(), async (req: Request, res: Response) => {
    const startTime = Date.now();
